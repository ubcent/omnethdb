...
type (
	...
	SynthesisCandidatesRequest  = memory.SynthesisCandidatesRequest
	SynthesisCandidatesResult   = memory.SynthesisCandidatesResult
	SynthesisCandidate          = memory.SynthesisCandidate
	SynthesisCandidateMember    = memory.SynthesisCandidateMember
	PromotionSuggestionsRequest = memory.PromotionSuggestionsRequest
	PromotionSuggestionsResult  = memory.PromotionSuggestionsResult
	PromotionSuggestion         = memory.PromotionSuggestion
	PromotionSuggestionMemory   = memory.PromotionSuggestionMemory
